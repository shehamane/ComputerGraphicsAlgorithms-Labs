...
//    Data *data = static_cast<Data * >(glfwGetWindowUserPointer(window));
//    if (data->state == WITH_POSTFILTRATION || data->state == WITHOUT_POSTFILTRATION) {
//        delete[] data->frame_buffer;
//        data->frame_buffer = new float[width * height * 3];
//        data->width = width;
//        data->height = height;
//        clearFrame(data->frame_buffer, width, height);
//    }
//    if (data->state == WITH_POSTFILTRATION)
//        makePostFiltration(data->frame_buffer, data->edges, data->width, data->height);
//    if (data->state == WITHOUT_POSTFILTRATION)
//        fillPolygonBaffle(data->frame_buffer, data->edges, data->width, data->height);
//}
//
//int main() {
...
//        glDrawPixels(data.width, data.height, GL_RGB, GL_FLOAT, data.frame_buffer);
//
